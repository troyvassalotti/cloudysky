...
export class CloudySky extends LitElement {
  ...
  render() {
    return html` <div class="wrapper shell">
       ...
       <div class="wrapper sundialWrapper" style="block-size: ${
         this.buttonSize
       }">
         <button
